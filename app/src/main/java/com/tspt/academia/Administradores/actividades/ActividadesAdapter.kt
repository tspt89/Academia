...
class ActividadesAdapter(val context: Context, val navController: NavController) : RecyclerView.Adapter<ActividadesAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        val f = "${actividades[position].nombre} ${actividades[position].horaFinal} - ${actividades[position].horaFinal}"
